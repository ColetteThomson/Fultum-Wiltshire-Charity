...
* A video highlights the latest event of the charity. This video would be regularly updated.
...
Images for the website have been downloaded from **Pexels**.  The icons (logo and social media) were downloaded from **Font Awesome**.  Some of the links were created using **Bootstrap**. The MP4 video was downloaded from **All Free Downloads**.
...
### Limitations
As there is no JavaScript functionality present in this website, the Query Form on the 'About Us' page will not store data.
This results in a browser error message when the 'submit' button is pressed.

### Features
* Newsflash banner - displays for 2.5 seconds on opening of 'Home' page.
