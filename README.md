...
### Features
* Newsflash banner - displays for 2.5seconds on opening of 'Home' page.
...
* [All Free Downloads](https://all-free-download.com/free-footage/) - utlised for the video.
...
* Testing will be performed to check for compatability across three web browsers (Google Chrome; Firefox; and Opera) 
